...
if (isset($_GET['detil']) && is_numeric($_GET['detil'])) {
	...
	<small>Untuk memunculkan rekening, <a href="'.$weburl.'dashboard/editform">tambah setting form</a> dengan setting:<br/>
	- Field : <code>Custom Field</code><br/>
	- Custom Field: <code>rekening</code>
	</small>
	</div>';
}
showfooter();

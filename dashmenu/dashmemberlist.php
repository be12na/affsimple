	...
	<div class="card-body">
	  <div class="row">	    
	    ...
	    <div class="col-sm-3 text-end">	    	
	    	<a href="member?id=add" class="btn btn-success">Add</a> &nbsp;
	...
	<tbody>
		...
		if (count($data) > 0) {
			foreach ($data as $data) {
				...
				<td>'.$data['IDMember'].'</td>
				<td>
				<a href="member?id='.$data['IDMember'].'">'.$data['NamaMember'].'</a>';
				...
				<span class="d-sm-none">
					...
					<br/><i class="fa-solid fa-user-tie"></i> <a href="member?id='.$data['IDSponsor'].'">'.$data['NamaSponsor'].'</a>
				</span>
				</td>
				...
				<td class="d-none d-sm-table-cell"><a href="member?id='.$data['IDSponsor'].'">'.$data['NamaSponsor'].'</a>';

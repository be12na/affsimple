  ...
  <div class="card-body" id="manual">
	  ...
	  <div class="mb-3 row">
	    ...
	    <div class="col-sm-10">
	      ...
	      <code>[harga]</code> utk menampilkan harga produk<br/>
	    	<code>[hargaunik]</code> utk menampilkan harga unik pembayaran<br/>
	    	<code>[namaproduk]</code> utk menampilkan nama produk</small>
	    </div>
	  </div>
  </div>
</div>

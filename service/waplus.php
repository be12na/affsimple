<?php
/*
Service Name: WAPlus v2
Service URL: https://partner.waplus.biz.id/cafebisnis
API Documentation: https://waplus.biz.id/page/dokumentasi-api
...
if (isset($settings['set_field1']) && $settings['set_field1'] != '' && isset($nohp) && isset($pesan)) {
    ...
    $urlapp = 'https://app.waplus.biz.id/send-message';
  
    if (isset($gambar) && $gambar != '') {
        $data['url'] = $urlgambar.'gambar/'.$gambar;
        $data['media_type'] = 'image';
        $data['caption'] = $pesan;
        $urlapp = 'https://app.waplus.biz.id/send-media';
  }
